...
//N2AbstractType *N2VariableCreator::createSimple(N2AbstractType::types type, string name, unsigned int cnt)
//{
//    switch (type) {
//    case N2AbstractType::BOOL:   return N2Register::self()->getMemoryAllocator()->createSimpleVar<N2Bool>(name,cnt);
//    case N2AbstractType::INT:    return N2Register::self()->getMemoryAllocator()->createSimpleVar<N2Int>(name,cnt);
//    case N2AbstractType::LONG:   return N2Register::self()->getMemoryAllocator()->createSimpleVar<N2Long>(name,cnt);
//    case N2AbstractType::FLOAT:  return N2Register::self()->getMemoryAllocator()->createSimpleVar<N2Float>(name,cnt);
//    case N2AbstractType::STRING: return N2Register::self()->getMemoryAllocator()->createSimpleVar<N2String>(name,cnt);
//    }
//    return NULL;
//}

//N2AbstractType *N2VariableCreator::createTable(N2AbstractType::types type, string name, int rows, int columns)
//{
//    switch (type) {
//    case N2AbstractType::BOOLTABLE:   return N2Register::self()->getMemoryAllocator()->createTableVar<N2BoolTable>(name,rows,columns);
//    case N2AbstractType::INTTABLE:    return N2Register::self()->getMemoryAllocator()->createTableVar<N2IntTable>(name,rows,columns);
//    case N2AbstractType::LONGTABLE:   return N2Register::self()->getMemoryAllocator()->createTableVar<N2LongTable>(name,rows,columns);
//    case N2AbstractType::FLOATTABLE:  return N2Register::self()->getMemoryAllocator()->createTableVar<N2FloatTable>(name,rows,columns);
//    case N2AbstractType::STRINGTABLE: return N2Register::self()->getMemoryAllocator()->createTableVar<N2StringTable>(name,rows,columns);
//    }
//    return NULL;
//}

//N2AbstractType *N2VariableCreator::createUser(string name)
//{
